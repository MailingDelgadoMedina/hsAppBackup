...
export default function TermUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = termRecord
      ...
      : initialValues;
    setWinter(cleanValues.winter);
    setSummer(cleanValues.summer);
    setFall(cleanValues.fall);
    setYear(cleanValues.year);
    setTermId(cleanValues.termId);
    setErrors({});
  };
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Term, idProp)
        : termModelProp;
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Term.copyOf(termRecord, (updated) => {
